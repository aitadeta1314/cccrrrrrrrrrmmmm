...
@interface K_DatePickerView () <UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation K_DatePickerView
...
//    [self.pickerView selectRow:[self.yearArr indexOfObject:self.year] inComponent:0 animated:YES];
    ...
    [self.pickerView selectRow:[self.hourArr indexOfObject:self.hour] inComponent:2 animated:YES];
    [self.pickerView selectRow:self.minuteInterval == 1 ? ([self.minuteArr indexOfObject:self.minute]) : (self.minuteArr.count / 2) inComponent:3 animated:YES];
